...
# define the app
DebuggingOn = bool(os.getenv('DEBUG', True))  # Whether the Flask app is run in debugging mode, or not.
app = Flask(__name__)
...
def list_files():
    """
        http://127.0.0.1:8080/list_files?bucket_name=comp4312_0864683
    """
    try:
...
def create_bk():
    """
        http://127.0.0.1:8080/create_bk?bucket_name=comp4312_0864683
    """
    try:
        bucket_name = ""
        #####################
        ...
        bucket_name = request.args.get('bucket_name', default='comp4312_0864683', type=str)
